document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".w-y-navigation-list");
  const headerRef = document.querySelector(".w-y-header");
  const navigationRef = document.querySelector(".w-y-navigation");
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".w-y-toggle-button img");
